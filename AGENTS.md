...
- You can connect to PostgreSQL on `raksasa` from `udara` (where Codex runs); `psql` is installed at `/Applications/Postgresql.app`.
- You can SSH to `techskills@raksasa`.
